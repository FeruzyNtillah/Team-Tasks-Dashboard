  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-1 right-1 min-w-4.5 h-4.5 bg-red-500 text-white text-xs rounded-full flex items-center justify-center animate-pulse">
      ...
      {isOpen && (
        <>
          ...
          {/* Panel */}
          <div className="absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-lg border border-gray-200 z-50 max-h-120 flex flex-col">
            {/* Header */}
